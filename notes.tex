...
\]
\[
 R^{P}\approx\frac{h^{2}}{24}\sum_{i=1}^{n-1}hf''\left(\frac{x_{i}+x_{i+1}}{2}\right) \approx\frac{h^{2}}{24}\int_{a}^{b}f''(x)\mathrm{d}x;
\]
\[
 R^{S}\approx-\frac{h^{4}}{2880}\sum_{i=1}^{n-1}hf^{IV}\left(\frac{x_{i}+x_{i+1}}{2}\right) \approx-\frac{h^{4}}{2880}\int_{a}^{b}f^{IV}(x)\mathrm{d}x.
\]
